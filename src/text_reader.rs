...
impl TextReader {
    ...
    pub fn update_wrapped_lines(&mut self, content: &str, width: usize, visible_height: usize) {
        ...
        debug!("Updated wrapped lines: {} total, {} visible", total_lines, visible_height);
    }
    ...
    pub fn clamp_scroll_offset(&mut self) {
        ...
        debug!("Clamped scroll offset to: {} (max: {})", self.scroll_offset, max_offset);
    }
    
    pub fn parse_styled_text(&self, text: &str, chapter_title: &Option<String>, palette: &Base16Palette, width: usize) -> Text {
    ...
    pub fn scroll_down(&mut self, _content: &str) {
        ...
        debug!("Scrolling down to offset: {}/{} (speed: {}, max: {})", 
               self.scroll_offset, self.total_wrapped_lines, self.scroll_speed, self.get_max_scroll_offset());
    }
    ...
    pub fn scroll_up(&mut self, _content: &str) {
        ...
        debug!("Scrolling up to offset: {}/{} (speed: {}, max: {})", 
               self.scroll_offset, self.total_wrapped_lines, self.scroll_speed, self.get_max_scroll_offset());
    }
