...
mod imp {
    ...
    impl RegionPool {
        ...
        pub fn initialize(&mut self) -> io::Result<()> {
            ...
            info!(
                "pool initialized: {pool_size} slots x {region_mb:.0} MB = {total_mb:.0} MB total"
            );
    ...
    mod tests {
        ...
        fn create_test_pool(pool_size: usize, region_size: usize) -> RegionPool {
            RegionPool::with_config_and_prefix(
                pool_size,
                region_size,
                test_prefix(),
                Duration::ZERO,
...
mod imp {
    ...
    impl RegionPool {
        ...
        pub fn with_config(pool_size: usize, region_size: usize) -> Self {
            Self::with_config_and_reuse_age(pool_size, region_size, DEFAULT_MIN_REUSE_AGE)
        }
    ...
    fn unsupported() -> io::Error {
        Error::new(
            ...
            "shared-memory kitty transfer is not supported on Windows",
        )
    }
}
