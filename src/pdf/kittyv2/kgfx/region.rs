...
mod imp {
    ...
    mod tests {
        ...
        fn test_write_overflow() {
            let mut region = MemoryRegion::create_with_pattern("kgfx-test-*", 10)
                .expect("failed to create region");
        ...
        fn test_name_collision_handling() {
            ...
            let region_a = MemoryRegion::create("/kgfx_test_collision", 100)
                .expect("failed to create region A");

            // Create region B with same name - should succeed (implementation unlinks first)
            let region_b = MemoryRegion::create("/kgfx_test_collision", 100)
                .expect("failed to create region B");
        ...
        fn test_debug_format() {
            let region = MemoryRegion::create_with_pattern("kgfx-dbg-*", 1024)
                .expect("failed to create region");
